...
def main_apv():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801864632923?text=' + tks)

        

    r1=requests.get("https://github.com/Bishwas-Roy11/BISHWAS/blob/main/Bishnu.txt").text
    ...
    if key1 in r1:
        ...
        print ("         ༄•───────────────────────────────────────•༄")
        print ("             \033[1;94mGIVE ME 100RS FOR APROVAL BISHNU")     
...
\033[33;1m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
\033[33;1m┃ Tools    : RENDOM CLONE               ┃
\033[33;1m┃ Owner    : BISHNU ROY                 ┃
\033[34;1m┃ Facebook : www.facebook.com/bishwas.roy.16┃
\033[34;1m┃ What'sapp: +8801864632923             ┃
\033[34;1m┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛"""
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[BISHNU]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
...
def yt():
	logo()
	os.system("xdg-open https://www.facebook.com/BISHNU.OFFICIAL.ACCOUNT")
	time.sleep(3)
	R()
